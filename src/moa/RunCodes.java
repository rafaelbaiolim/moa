...
class Main {
    ...
    protected int calcularPrimeiraHeuristica(String config) {
        int out = 0;
    ...
    protected int calcularSegundaHeuristica(int[] config) {
        int out = 0;
    ...
    protected int calcularTerceiraHeuristica(Estado config) {
        int distanciaR = 0;
    ...
    protected int calcularQuintaHeuristica(Estado config) {
        int h1, h2, h3;
    ...
    protected int calcularQuartaHeuristica(Estado config) {
    ...
    public static void main(String[] args) {
        ...
        Main main = new Main();
        main.algoritmoAEstrela(casoMoodle);
    }
}
